...
WHERE CAST([Tipo Vínculo] AS VARCHAR(100)) NOT IN ("30","31","35","50","60","65","70","75","90","95","96","97") AND
RIGHT(CAST([PIS] AS VARCHAR(100)),2)= '12'
...
WHERE CAST([TP VINCL] AS VARCHAR(100)) NOT IN ("30","31","35","50","60","65","70","75","90","95","96","97") AND
RIGHT(CAST([PIS] AS VARCHAR(100)),2)= '12'
...
WHERE CAST([TP VINCULO] AS VARCHAR(100)) NOT IN ("30","31","35","50","60","65","70","75","90","95","96","97") AND
RIGHT(CAST([PIS] AS VARCHAR(100)),2)= '12'
...
WHERE CAST([TP VINCULO] AS VARCHAR(100)) NOT IN ("30","31","35","50","60","65","70","75","90","95","96","97")
...
WHERE CAST([tipovinculo] AS VARCHAR(100)) NOT IN ("30","31","35","50","60","65","70","75","90","95","96","97") AND
RIGHT(CAST([pis] AS VARCHAR(100)),2)= '12'
