...
WHERE [Tipo Vínculo] NOT IN (30,31,35,50,60,65,70,75,90,95,96,97) AND
RIGHT([PIS],2)= '12'
...
WHERE [TP VINCL] NOT IN (30,31,35,50,60,65,70,75,90,95,96,97) AND
RIGHT([PIS],2)= '12'
...
WHERE [TP VINCULO] NOT IN (30,31,35,50,60,65,70,75,90,95,96,97) AND
RIGHT([PIS],2)= '12'
...
WHERE [TP VINCULO] NOT IN (30,31,35,50,60,65,70,75,90,95,96,97)
...
WHERE [tipovinculo] NOT IN (30,31,35,50,60,65,70,75,90,95,96,97) AND
RIGHT([pis],2)= '12'
...
WHERE 
[tipovinculo] NOT IN (30,31,35,50,60,65,70,75,90,95,96,97) AND
RIGHT([pis],2)= '12'
