...
WHERE [Tipo Vínculo] IN ('10', '15', '20', '25', '40', '55', '80') AND RTRIM(LTRIM([Vínculo Ativo 31 12])) = '1'
GROUP BY [CNPJ Raiz]
;
#delimit cr
...
WHERE [TP VINCULO] IN ('10', '15', '20', '25', '40', '55', '80') AND RTRIM(LTRIM([EMP EM 31 12])) = '1'
GROUP BY [RADIC CNPJ]
...
WHERE [tipovinculo] IN ('10', '15', '20', '25', '40', '55', '80') AND RTRIM(LTRIM([vinculoativo3112])) = '1'
GROUP BY [cnpjraiz]
